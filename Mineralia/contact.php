    ...
    <div class="mineral-content">
        <div class="mineral-single">
            <div class="mineral-body">
                ...
                <form method="POST" action="contact.php" style="display:flex;flex-direction:column;gap:1.2rem;max-width:600px;">

                    <div style="display:flex;flex-direction:column;gap:0.4rem;">
                        <label style="color:var(--stone-300);font-size:0.9rem;">Nume complet *</label>
                        <input type="text" name="nume" value="<?php echo htmlspecialchars($nume_val); ?>"
                    ...
                    <div style="display:flex;flex-direction:column;gap:0.4rem;">
                        ...
                        <input type="text" name="subiect" value="<?php echo htmlspecialchars($subiect_val); ?>"
                    ...
                    <div style="display:flex;flex-direction:column;gap:0.4rem;">
                        ...
                        <textarea name="mesaj" rows="5" placeholder="Scrie mesajul tau aici..."
                            style="padding:0.7rem 1rem;border-radius:8px;border:1px solid var(--stone-600);background:var(--stone-800);color:var(--stone-100);font-size:1rem;outline:none;resize:vertical;"><?php echo htmlspecialchars($mesaj_val); ?></textarea>
                    </div>
        ...
        <div class="footer-inner">
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <p>Proiect educational despre mineralele si rocile din natura inconjuratoare. Lucrarea de laborator N4 - Tehnologii Web.</p>
                </div>
                <div>
            ...
            <div class="footer-bottom">
                <span>&copy; 2025 Mineralia &middot; Lucrare de Laborator N4 &middot; Tehnologii Web</span>
